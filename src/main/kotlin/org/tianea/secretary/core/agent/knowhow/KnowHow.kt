 ...
 * 절차적 노하우 도메인 모델.
 *
 * 사용자와의 대화에서 추출된 "재사용 가능한 방법론"을 표현한다.
 * raw 메시지 `vector_store`와 별개의 `know_how` 테이블에 저장되며,
 ...
 * @property updatedAt 지식 본문(intent/body/importance/embedding)이 마지막으로 수정된 시각.
 *   사용 카운트만 증가하는 [KnowHowStore.touch] 호출은 [lastUsedAt]이 추적하며 이 값은 변하지 않는다.
