 ...
 *
 * Koog 도구·그래프 노드·feature 핸들러는 모두 agent 코루틴 안에서 실행되므로
 * `currentCoroutineContext()[ChatContext]`로 어느 chat의 어느 메시지에 대한 요청인지 식별한다.
 * `AssistantRunner`가 agent 호출 전 주입한다.
 *
